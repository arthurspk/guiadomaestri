...
- **📨 · Prompt: validar el Discord de Maestri** ([prompts](prompts/validar-discord-maestri.md)) — un prompt listo para un Claude con acceso a Discord que valida y recopila información.
