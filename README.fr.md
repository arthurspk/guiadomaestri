...
- **📨 · Prompt : valider le Discord de Maestri** ([prompts](prompts/validar-discord-maestri.md)) — un prompt prêt pour un Claude ayant accès à Discord, pour valider et collecter des informations.
